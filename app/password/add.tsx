    ...
    <SafeAreaView className="flex-1" style={{ backgroundColor: '#e5e7eb' }}>
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} className="flex-1">
          ...
          <View>
            ...
            <View>
              <TextInput
                ...
                style={{ ...cardStyle, fontSize: 16 }}
              />
              <View className="absolute right-3 top-5 flex-row" style={{ marginTop: Platform.OS === 'ios' ? 0 : -5 }}>
        ...
        <View className="px-5 py-5 pb-8">
          ...
          >
            <Text className={`font-semibold text-base ${isLoading || !platform || !username || !password ? 'text-[#6b7280]' : 'text-white'}`}>
              {isLoading ? '保存中...' : '保存'}
            </Text>
          </TouchableOpacity>
        </View>
